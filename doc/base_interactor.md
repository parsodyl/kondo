...
The Interactor exists to serve the Hako. It should not always just blindly re-expose Repository methods. It must tailor the data exactly how the Hako needs it.
...
5. [ ] **Are shared tools mixins?** (Analytics, connectivity).